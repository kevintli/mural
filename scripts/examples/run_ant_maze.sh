softlearning run_example_local examples.ant_maze \
        --exp-name=ant-maze `# This is the name your experiment will be saved under ~/ray_results` \
        ...
        --domain=Ant  `# Environment domain, your environment name should be something like <Domain><Task> concatenated together` \
        --task=MazeOneWallEnv-v0  `# Training environment task` \
        --task-evaluation=MazeOneWallEnv-v0  `# Evaluation environment task` \
