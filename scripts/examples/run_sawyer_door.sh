softlearning run_example_local examples.sawyer_door \
        --exp-name=sawyer-door `# This is the name your experiment will be saved under ~/ray_results` \
        ...
        --task=DoorPullHookEnv-v0  `# Training environment task` \
        --task-evaluation=DoorPullHookEnv-v0  `# Evaluation environment task` \
