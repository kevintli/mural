softlearning run_example_local examples.sawyer_push \
        --exp-name=sawyer-push `# This is the name your experiment will be saved under ~/ray_results` \
        ...
        --task=PushForwardEnv-v0  `# Training environment task` \
        --task-evaluation=PushForwardEnv-v0  `# Evaluation environment task` \
