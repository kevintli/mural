...
# def register_dclaw_environments():
#     for dclaw_environment in DCLAW_ENVIRONMENT_SPECS:
#         gym.register(**dclaw_environment)
     
#     gym_ids = tuple(
#         environment_spec['id']
#         for environment_spec in  DCLAW_ENVIRONMENT_SPECS)
...
def register_environments():
    ...
    # registered_dclaw_environments = register_dclaw_environments()
    # try:
    #     import dsuite
    # except:
    #     import robel
